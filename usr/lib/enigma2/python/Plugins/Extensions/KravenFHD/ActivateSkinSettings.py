...
config.plugins.KravenFHD.Infobox3 = ConfigSelection(default="sat", choices = [
				("tunerinfo", _("Tunerinfo")),
				("cpu", _("CPU + Load")),
				("temp", _("Temperature + Fan"))
				])
	...
	<eLabel position="0,87" size="1920,3" backgroundColor="KravenIBLine" zPosition="-8" />"""
	  ...
	  <eLabel position="0,87" size="1920,3" backgroundColor="KravenIBLine" zPosition="-8" />"""
		...
		if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/MediaPortal/skins_1080/KravenFHD/skin.xml"):
			system("rm -rf /usr/lib/enigma2/python/Plugins/Extensions/MediaPortal/skins_1080/KravenFHD/skin.xml")
