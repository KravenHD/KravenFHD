...
class ActivateSkinSettings:
	...
	<eLabel position="0,0" size="1920,27" backgroundColor="#00000000" zPosition="8" />"""
		...
		if config.plugins.KravenFHD.IconStyle2.value == "icons-light2":
			system("tar xf /usr/lib/enigma2/python/Plugins/Extensions/KravenFHD/data/icons-white.tar.gz -C /usr/share/enigma2/KravenFHD/icons/")
		else:
			system("tar xf /usr/lib/enigma2/python/Plugins/Extensions/KravenFHD/data/icons-black.tar.gz -C /usr/share/enigma2/KravenFHD/icons/")
		...
		if self.E2DistroVersion == "openatv" and self.InternetAvailable:
			if fileExists("/usr/lib/enigma2/python/Components/Converter/MSNWeather.pyo"):
				...
				if not fileExists("/usr/share/enigma2/KravenFHD/msn_weather_icons/1.png"):
					system("wget -q http://coolskins.de/downloads/kraven/msn-icon.tar.gz -O /tmp/msn-icon.tar.gz; tar xf /tmp/msn-icon.tar.gz -C /usr/share/enigma2/KravenFHD/")
			else:
